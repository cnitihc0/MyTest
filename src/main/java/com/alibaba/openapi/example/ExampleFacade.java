...
public final class ExampleFacade implements OceanApiFacadeInterface, SDKListener {
	...
	public final class ApiExample {
		...
		public final ExampleFamilyGetResult exampleFamilyGet(ExampleFamilyGetParam param) {
			...
			reqPolicy.setHttpMethod(HttpMethodPolicy.POST).setNeedAuthorization(false).setRequestSendTimestamp(false)
					.setUseHttps(false).setUseSignture(false).setAccessPrivateApi(false);
			...
			try {
				...
				ExampleFamilyGetResult ret = getAPIClient().send(req, ExampleFamilyGetResult.class, reqPolicy,
		...
		public final ExampleFamilyPostResult exampleFamilyPost(ExampleFamilyPostParam param, String accessToken) {
			RequestPolicy reqPolicy = new RequestPolicy();
			reqPolicy.setHttpMethod(HttpMethodPolicy.POST).setNeedAuthorization(true).setRequestSendTimestamp(false)
					.setUseHttps(false).setUseSignture(true).setAccessPrivateApi(false);
			...
			try {
				...
				ExampleFamilyPostResult ret = getAPIClient().send(req, ExampleFamilyPostResult.class, reqPolicy,
						serializerListeners.values(), deSerializerListeners.values());
				return ret;
			} catch (Exception e) {
				throw new RuntimeException(e);
